...
function preload() {
  // Main looping video
  finalVid = createVideo("/nine_lights_final/final_result/final_result/final_reuslt_.webm");
  finalVid.hide();
  finalVid.volume(0);
  finalVid.attribute("muted", "");

  // UI overlay (full size 1080×900)
  finalBtnImg = loadImage("/nine_lights_final/final_result/final_result/bg_final_button.png");
}
